 ...
 * y(s,t)
 * z(s,t)
 * Mais il faut aussi définir le bon intevralle des paramètres t et s
 * ainsi que le nombre de segments de la discrétisation de ces deux intevralles.
 */
...
protected:
    ...
    double minT, maxT;       //!< définit l'intevralle en t
    int numSegT;              //!< nb de subdivisions de l'intevralle en t
    double minS, maxS;       //!< définit l'intevralle en s
    int numSegS;              //!< nb de subdivisions de l'intevralle en s
    float time = 0;
    double ds = 0.1;
    double dt = 0.1;
};
